var hju	= {
	...
	upperMobileNavi:	function(){
		if ($('#upper_mobile_navi').length)
		{
			$('#upper_mobile_navi a').click(function(){
				var a			= $(this),
					mob_navi	= $('#upper_mobile_navi'),
					top_navi	= $('#upper_navi').length ? $('#upper_navi') : false;
				if (top_navi)
				{
					if (top_navi.hasClass('expanded'))
					{
